...
export class SalaryBadge {
    ...
    /**
     * Injects CSS styles for the salary badge to match Naukri's design system.
     */
    injectStyles() {
        if (document.getElementById('resumehub-naukri-salary-badge-styles')) return;

        const style = document.createElement('style');
        style.id = 'resumehub-naukri-salary-badge-styles';
        style.textContent = `
